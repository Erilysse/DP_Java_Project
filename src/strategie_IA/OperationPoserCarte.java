...
/**
 * OperationPoserCarte est une classe qui implémente l'interface Strategy.
 * 
 * @see Strategy
 * 
 * @author manic
...
public class OperationPoserCarte implements Strategy {
	 ...
	 * Si sa carte est :
	 * - Apocalypse, elle est posée si le joueur a le plus de points de prières par rapport aux autres joueurs.
	 * - Croyant, elle est posée quelque soit le contexte.
	 * - GuideSpirituel, elle est posée si le camp du joueur est vide.
	 * - DeusEx, elle est posée quelque soit le contexte.
	 */
