 ...
 * de cartes que possède le <code>camp</code>. C'est une classe implémentant
 * l'interface Observable, avec comme Observeur la classe PopupCamp.
 * 
 * @see GuideSpirituel
 * @see Carte
 * @see Joueur
