...
public class Jeu extends Observable {
	...
	/**
	 * numéro du joueur dans la <code>ListJoueur</code> qui joue actuellement
	 * son tour.
	 */
	private int joueuractuel;

	/**
	 * Booléen permettant de switcher entre la vue graphique et la vue console
	 * au niveau des entrées claviers. A false, elle active les scanners pour
	 * les entrées claviers alors qu'à true, elle permets l'affichage graphique.
	 */
	 ...
	 * PiocheDivinite, De, Contrôl et Centre. Le <code>nbJoueur</code> est la
	 * taille de la liste <code>ListJoueur</code>. Initialisation à zéro du
	 * <code>joueurMaxPP</code>, <code>joueurMinPP</code> et
	 * <code>joueuractuel</code> ; initialisation à false des booléens
	 * <code>commence</code> et <code>vue</code> ; initialisation à un de
	 * <code>nbTour</code>.
	 */
	public Jeu() {
	...
	/**
	 * Retourne le booléen permettant de savoir dans quelle vue nous sommes
	...
	/**
	 * Met à jour le booléen permettant de savoir dans quelle vue nous sommes
	 * (graphique ou console).
	 * 
	 * @param vue
	 *            le nouveau booléen de vue.
	 */
	...
	/**
	 * Calcule et Retourne le numéro d'un joueur dans <code>ListJoueur</code>
	 * qui a le moins de points de prières.
	 * 
	 * @return un numéro d'un joueur.
	 */
	...
	/**
	 * Incrémente le nombre de tour et notifie la vue de ce changement.
	 */
	public void Tourplusun() {
		this.nbTour++;
		setChanged();
		notifyObservers("NEWTOUR");
	}
}
