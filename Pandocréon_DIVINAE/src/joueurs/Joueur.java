...
/**
 * Joueur est une classe abstraite qui modélise un joueur. Il implémente l'interface
 ...
 * centre et la pioche du jeu. Il est observable par la classe AffichageJoueur
 * du moteur graphique.
 * 
 * @see Observable
 * @see Jeu
...
public abstract class Joueur extends Observable {
	/**
	 * Booléen permettant de dire si le joueur a le droit de défausser ou pas.
	 */
	...
	/**
	 * Constructeur Joueur. Par défaut, initialisation des booléens à false sauf
	 * defausse qui est à true ; initialisation de la liste des points d'actions
	 * et du nombre de points de prière à 0 ; création du deck, du camp du
	 * joueur, et du contrôleur.
	 * 
	 * @param humain
	...
	/**
	 * Retourne le booléen qui permet de savoir si le joueur a le droit de défausser
	 * ou pas.
	 * 
	 * @return un booléen.
	 */
	...
	/**
	 * Met à jour le booléen qui permet de savoir si le joueur a le droit de
	 * défausser ou pas.
	 * 
	 * @param defausse
	 *            nouveau booléen qui va remplacer l'ancien.
	 */
	 ...
	 * défausser, puis si c'est le cas, enlève unecette carte de la main choisie
	 * par le joueur, afin de la mettre dans la pioche.
	 * 
	 * @see MainDuJoueur
	 * @see PiochE
	 */
